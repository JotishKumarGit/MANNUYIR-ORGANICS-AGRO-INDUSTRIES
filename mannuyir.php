  ...
  <div class="container-fluid bg-primary p-5 hero-header mb-5">
    <div class="row py-5">
      <div class="col-12 text-center">
        <h1 class="display-1 text-white animated zoomIn">Mannuyir</h1>
        <a href="" class="h4 text-white">Home</a>
        <i class="far fa-circle text-white px-2"></i>
        <a href="" class="h4 text-white">Mannuyir</a>
      </div>
    </div>
  </div>
  <!-- Hero End -->
  ...
  <div class="container py-5">
    <div class="row align-items-center">
      ...
      <div class="col-lg-6 mb-4 mb-lg-0">
        <img src="img/mannuyir.jpeg" alt="Clove" class="img-fluid rounded shadow" />
      </div>
      ...
      <div class="col-lg-6">
        ...
        <ul class="list-unstyled mb-4">
          <li>
            <i class="fa fa-check text-primary me-2"></i>100% Organic &
            Natural
          </li>
          <li>
            <i class="fa fa-check text-primary me-2"></i>No Chemicals or
            Preservatives
          </li>
          <li>
            <i class="fa fa-check text-primary me-2"></i>Rich in Nutrients &
            Flavor
          </li>
          <li>
            <i class="fa fa-check text-primary me-2"></i>Carefully Harvested &
            Packed
          </li>
        </ul>
