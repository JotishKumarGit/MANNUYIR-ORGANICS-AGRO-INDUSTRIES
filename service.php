                ...
                <div class="col-lg-7 text-center">
                    <div class="text-center mx-auto mb-4" style="max-width: 600px">
                        ...
                        <h1 class="display-5 text-white">
                            Get 50% Off On Millets & Pulses – First Purchase Only!
                        </h1>
                    </div>
                    <p class="text-white mb-4">
                        Stock your pantry with our premium-quality unpolished pulses and organically grown millets.
                        Enjoy half-price on your first order — fresh, chemical-free, and packed with nutrition.
                        Limited time only. Don’t miss out on healthy savings!
                    </p>
                    <a href="" data-bs-toggle="modal" data-bs-target="#enquiryModal"
                        class="btn btn-primary py-md-3 px-md-5 me-3">Enquery Now</a>
