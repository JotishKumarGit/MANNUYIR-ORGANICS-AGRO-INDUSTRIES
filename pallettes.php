...
<head>
    ...
    <meta content="Organic Pallettes, Bio Fertilizer, Natural Soil Enhancer" name="keywords" />
    <meta content="High-quality organic pallettes for sustainable farming and gardening." name="description" />
    ...
    <div class="container-fluid bg-primary p-5 hero-header mb-5">
        <div class="row py-5">
            <div class="col-12 text-center">
                <h1 class="display-1 text-white animated zoomIn">Organic Pallettes</h1>
                <a href="index.php" class="h4 text-white">Home</a>
                <i class="far fa-circle text-white px-2"></i>
                <a href="#" class="h4 text-white">Organic Pallettes</a>
            </div>
        </div>
    </div>
    <!-- Hero Section End -->
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                ...
                <ul class="list-unstyled mb-4">
                    ...
                    <li><i class="fa fa-check text-primary me-2"></i>Improves Soil Health & Structure</li>
